...
class ManualControl(tk.Frame):
    ...
    def __init__ (self, parent, controller,sendData):
        ...
        upButton=tk.Button(self,text="Forward",
                              command=lambda:car.forward())
        downButton=tk.Button(self,text="Back",
                              command=lambda:car.back())
        leftButton=tk.Button(self,text="Left",
                              command=lambda:car.left())
        rightButton=tk.Button(self,text="Right",
                              command=lambda:car.right())
        stopButton=tk.Button(self,text="Stop",
                              command=lambda:car.stop())
        
        NALIVAIButton=tk.Button(self,text="NALIVAI",
                              command=lambda:pump.on(1.5))
        ...
        NALIVAIButton.config(width=controlButtonWidth,   height=controlButtonHeight,   background=controlButtonBackground)
        ...
        NALIVAIButton.grid(row=4,column=3)
